help:
	...
	@echo "  build-windows-arm64 - Build for Windows"
...
build-windows:
	GOOS=windows GOARCH=amd64 go build -o distrib/talostpl-windows-amd64.exe main.go

build-windows-arm64:
	GOOS=windows GOARCH=arm64 go build -o distrib/talostpl-windows-arm64.exe main.go
